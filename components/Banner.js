                        ...
                        <div className="row">
                            <div className="col-xl-6 col-lg-7 col-md-12">
                                <div className="hero__caption">
                                    ...
                                    {!isMentorLoggedIn&&<a href="/mentorRegister" className="btn hero-btn animate__animated animate__fadeInLeft" data-animation="fadeInLeft" data-delay="1s" tabIndex="0" style={{animationDelay: "1s"}}>Be a Mentor</a>} 
                                    {isMentorLoggedIn === true ? (<><br/><br/><a href="/dashboard" className="btn hero-btn animate__animated animate__fadeInLeft" data-animation="fadeInLeft" data-delay="1s" tabIndex="0" style={{animationDelay: "1s"}}>Dashboard</a></>):null}
                                </div>
                            </div>
                        </div>
                    </div>          
