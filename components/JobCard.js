    ...
    <div className=" tw-border-2 tw-p-4 tw-rounded-xl tw-min-h-[360px] tw-w-[340px] tw-m-4 tw-shadow-lg tw-relative">
      <div className="tw-flex tw-justify-between tw-items-center tw-mb-2">
        ...
        <div>
          <button
            onClick={handleApply}
            className="tw-bg-purple-700 tw-text-white tw-border-none tw-py-2 tw-px-4 tw-rounded-md tw-flex tw-items-center"
          >
      ...
      <p className="tw-text-sm tw-font-normal tw-text-gray-500 tw-absolute tw-bottom-6">
        {job.posted}
      </p>
    </div>
  );
