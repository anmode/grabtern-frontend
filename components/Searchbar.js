...
All
        ...
        <MenuItem value="bookmarked"  sx={{ fontSize: 20 }}><BookmarksIcon sx={{ marginRight: "20px" }} /> <h2
              className="animate-charcter"
              style={{
                // textTransform: "uppercase",
                backgroundImage:
        ...
        <MenuItem value="web"  sx={{ fontSize: 20 }}> <WebIcon sx={{ marginRight: "20px" }} /> <h2
              className="animate-charcter"
              style={{
                textTransform: "uppercase",
                backgroundImage:
        ...
        <MenuItem value="Blockchain"  sx={{ fontSize: 20 }}>  <CurrencyBitcoinIcon sx={{ marginRight: "20px" }} /> <h2
              className="animate-charcter"
              style={{
                textTransform: "uppercase",
                backgroundImage:
