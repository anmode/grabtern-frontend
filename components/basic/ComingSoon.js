  ...
  return (
    <main>
      <div className={clsx(
        ...
        {/* back button */}
        <Button  onClick={() => router.back()} variant="secondary" LeftIcon={MdKeyboardArrowLeft} text="back" className="tw-flex tw-items-center"/>
        ...
        >
          ...
          <form className={clsx(
            ...
            <Input name="email" placeholder="Your Email" value="" handleChange={()=> {}}/>
            <Button text="Subscribe" type="submit" className="tw-w-full tw-mt-4 sm:tw-mt-0 sm:tw-w-fit"/>
          </form>
