...
const MentorCard = ({ mentor }) => {
  return (
        <div className="card-container tw-flex flex-lg-column align-center tw-rounded-2xl tw-gap-5">
         <div className="upper-container tw-bg-[#7c4dff] tw-h-1/3 tw-w-full tw-rounded-t-2xl">
