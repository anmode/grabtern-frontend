...
const Sidebar = ({setComponent}) => {
  ...
  return (
    ...
    <>
      <div>
        <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="tw-inline-flex tw-items-center tw-p-2 tw-mt-2 tw-ml-3 tw-text-sm tw-text-gray-500 tw-rounded-lg tw-sm:hidden tw-hover:bg-gray-100 tw-focus:outline-none tw-focus:ring-2 tw-focus:ring-gray-200">
        ...
        <aside id="default-sidebar" className="tw-fixed tw-top-10 tw-left-0 tw-z-40 tw-w-64 tw-h-screen tw-transition-transform tw-translate-x-0 sm:tw-translate-x-0 " aria-label="Sidebar">
