      ...
      <div className="tw-bg-grey-100 tw-flex tw-flex-col tw-items-center tw-justify-center tw-max-w-[390px] tw-gap-5 tw-rounded-[10px] tw-shadow-xl tw-shadow-black/10 tw-rounded-[36px] tw-shadow-[8px 0 8px 8px rgba(255, 255, 255, 0.8)]">
        ...
        <div className="tw-flex tw-flex-col tw-items-center tw-justify-center ">
          ...
          <div className="tw-mt-5 tw-flex tw-text-gray-950 tw-flex-col tw-item-center tw-relative tw-mx-[10px]  tw-mb-6 tw-gap-3">
            ...
            {/* Mentor Name */}
            <h1 className="tw-text-[22px] tw-text-[#4338CA]  tw-font-bold tw-text-center ">{name}</h1>
        ...
        <div className=" tw-pt-[10px] tw-pb-[30px] tw-px-[30px] tw-items-stretch tw-w-full">
          ...
          <div className="tw-flex tw-flex-col">
            ...
            <h1 className="tw-font-bold tw-text-[20px] tw-mb-8;">
              About
            </h1>
            <p className="tw-leading-[1.6] tw-text-[#636b6f] tw-text-[13px] tw-font-normal tw-m-0 tw-text-justify">{about}</p>
          </div>


          {/* Mentor Social Links, Share Icon and About section */}
          {/* <div className="tw-bg-blue-500 tw-flex tw-flex-col tw-mb-[22px]"> */}
            {/* Mentor Social Links and Share Icon */} {/* Mentor Social Links Container */}

            <div className=" tw-flex tw-flex-row tw-text-[#4338CA] tw-gap-4  tw-items-center  tw-justify-center tw-m-[5px] tw-px-5 tw-py-0">
              <Link className="tw-flex tw-items-center tw-justify-center tw-bg-[#eceeef] tw-text-[#818a91] tw-w-[30px] tw-h-[30px] tw-rounded-full tw-transition-all tw-duration-[0.2s] tw-ease-linear tw-mr-2 hover:tw-bg-[#ea4c89] hover:tw-text-white" href={`mailto:${email}`}>
                <MdAlternateEmail className="tw-text-[20px] " />
              </Link>
              <Link className="tw-flex tw-items-center tw-justify-center tw-bg-[#eceeef] tw-text-[#818a91] tw-w-[30px] tw-h-[30px] tw-rounded-full tw-transition-all tw-duration-[0.2s] tw-ease-linear tw-mr-2 hover:tw-bg-[#007bb6] hover:tw-text-white"
                href={`https://www.linkedin.com/in/${socialLinks.linkedin}`}
              >
                <FaLinkedin className="tw-text-[20px] " />
              </Link>
              <Link className="tw-flex tw-items-center tw-justify-center tw-bg-[#eceeef] tw-text-[#818a91] tw-w-[30px] tw-h-[30px] tw-rounded-full tw-transition-all tw-duration-[0.2s] tw-ease-linear tw-mr-2 hover:tw-bg-[#00aced] hover:tw-text-white" href={`https://www.twitter.com/${socialLinks.twitter}`}>
              <FaTwitter className="tw-text-[20px] " />
              </Link>
              {/* Mentor Share Icon Container */}
              <div onClick={handleSharePage} className="tw-flex tw-items-center tw-justify-center tw-bg-[#eceeef] tw-text-[#818a91] tw-w-[30px] tw-h-[30px] tw-rounded-full tw-transition-all tw-duration-[0.2s] tw-ease-linear tw-mr-2 hover:tw-bg-[#4338CA] hover:tw-text-white">
