...
function MentorAbout({ mentorDetail }) {
  return (
    <div>
      <div
        className={`${styles1.about}  tw-flex tw-flex-col tw-relative   tw-items-start  tw-mt-[7rem] tw-gap-[60px] tw-flex-wrap`}
      >
        <div
          className={`${styles1.aboutSection} tw-relative tw-right-[107px] tw-flex tw-flex-row`}
        >
          <div
            className={`${styles1.mentorDiv1} mentorDiv1 tw-ml-32 tw-p-32 tw-relative tw-flex tw-flex-col tw-items-center tw-justify-center tw-border-r-2 tw-border-r-[black]`}
          >
            <img
              src={mentorDetail?.mentorImg}
              alt="not found"
              className="tw-rounded-full tw-w-48 tw-shadow-xl tw-shadow-black/10 tw-h-48 tw-justify-center tw-flex"
            />
            <h1 className="tw-mt-10 tw-text-5xl tw-font-semibold">
              {mentorDetail?.name}
            </h1>
          ...
          <div
            className={`${styles1.mentorDiv2} tw-flex tw-flex-col tw-relative tw-top-28 tw-mt-8`}
          >
            <h1
              className={`${styles1.aboutHeading} tw-ml-8 tw-relative tw-top-10 tw-text-5xl`}
            >
              About
            </h1>
            <p
              className={`${styles1.description} tw-w-[523px] tw-ml-8 tw-relative tw-top-10`}
            >
              {mentorDetail?.description}
            </p>
            <div
              className={`${styles1.linkSection} tw-flex tw-flex-row tw-relative tw-top-36  tw-pl-14`}
            >
