...
function JobApplicationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.captcha !== captcha) {
      ...
      setCaptchaError('');
      try {
        const response = await fetch('http://localhost:8000/api/jobApplication/submit', {
          method: 'POST',
          headers: {
  ...
  return (
    ...
    <div className="tw-bg-[#845ec2] tw-text-white tw-p-6 tw-text-center">
        <h1 className="tw-text-3xl tw-text-white tw-font-bold">{particularJob?.title}</h1>
    ...
    <div className="tw-p-6 tw-max-w-screen-md tw-mx-auto tw-bg-gray-100 tw-rounded-lg tw-shadow-lg">
      <button onClick={() => router.push('/career')} className="tw-text-[#845ec2] tw-hover:underline">
        <span>&larr;</span> Back to all job openings
      </button>
      <h2 className="tw-text-xl tw-text-gray-800 tw-font-semibold tw-mt-2">Apply for this job</h2>
      <form className="tw-mt-4" onSubmit={handleSubmit}>
        <div className="tw-mb-4">
          <label htmlFor="resume" className="tw-block tw-text-[#845ec2]-500 tw-mb-1 tw-cursor-pointer">Upload resume</label>
          <input
            type="text"
            id="resume"
            name="resume"
        ...
        <div className="tw-mb-4">
          <label htmlFor="firstName" className="tw-block tw-text-gray-700 tw-mb-1">First Name *</label>
          <input
            type="text"
            id="firstName"
            name="firstName"
        ...
        <div className="tw-mb-4">
          <label htmlFor="middleName" className="tw-block tw-text-gray-700 tw-mb-1">Middle Name</label>
          <input
            type="text"
            id="middleName"
            name="middleName"
        ...
        <div className="tw-mb-4">
          <label htmlFor="lastName" className="tw-block tw-text-gray-700 tw-mb-1">Last Name *</label>
          <input
            type="text"
            id="lastName"
            name="lastName"
        ...
        <div className="tw-mb-4">
          <label htmlFor="email" className="tw-block tw-text-gray-700 tw-mb-1">Email *</label>
          <input
            type="email"
            id="email"
            name="email"
        ...
        <div className="tw-mb-4">
          <label htmlFor="mobilePhone" className="tw-block tw-text-gray-700 tw-mb-1">Mobile Phone *</label>
          <input
            type="tel"
            id="mobilePhone"
            name="mobilePhone"
        ...
        <div className="tw-mb-4 tw-flex tw-flex-wrap gap-4">
          <div className="tw-w-full tw-sm:w-1/2">
            <label className="tw-block tw-text-gray-700 tw-mb-1">Experience</label>
          ...
          <div className="tw-w-full tw-sm:w-1/2">
            <label htmlFor="currentSalary" className="tw-block tw-text-gray-700 tw-mb-1">Current Salary(LPA)</label>
            <input
              type="text"
              id="currentSalary"
              name="currentSalary"
        ...
        <div className="tw-mb-4 tw-flex tw-flex-wrap tw-gap-4">
          <div className="tw-w-full tw-sm:w-1/2">
            <label htmlFor="expectedSalary" className="tw-block tw-text-gray-700 tw-mb-1">Expected Salary(LPA)</label>
            <input
              type="text"
              id="expectedSalary"
              name="expectedSalary"
          ...
          <div className="tw-w-full tw-sm:w-1/2">
            <label htmlFor="availableToJoin" className="tw-block tw-text-gray-700 tw-mb-1">Available To Join (in days)</label>
            <input
              type="number"
              id="availableToJoin"
        ...
        <div className="tw-mb-4">
          <label htmlFor="currentLocation" className="tw-block tw-text-gray-700 tw-mb-1">Current Location</label>
          <input
            type="text"
            id="currentLocation"
        ...
        <div className="tw-mb-4">
          <label htmlFor="notes" className="tw-block tw-text-gray-700 tw-mb-1">Notes</label>
          <textarea
            id="notes"
            name="notes"
        ...
        <div className="tw-mb-4">
  <label className="tw-block tw-text-gray-700 tw-mb-1">Ready for assessment*</label>
    ...
    <label className="tw-flex tw-items-center">
      ...
      <span className="tw-ml-2">No</span>
        ...
        <div className="tw-mb-4 tw-flex tw-items-center">
          <label htmlFor="captcha" className="tw-block tw-text-gray-700 tw-mb-1">Captcha: <span className="tw-px-2 tw-py-1 tw-border tw-border-gray-300 tw-rounded-lg tw-bg-white">{captcha}</span></label>
          <div className="tw-ml-auto tw-flex tw-gap-2 tw-items-center">
            ...
            />
            <button type="button" onClick={() => setCaptcha(generateCaptcha())} className="tw-text-[#845ec2]-500 tw-hover:underline">↻ Regenerate Captcha</button>
          </div>
        ...
        <div className="tw-mb-4 tw-flex tw-items-start">
          ...
          />
          <label htmlFor="consent" className="tw-ml-2 tw-text-gray-700">By applying you hereby accept the data processing terms under the Privacy Policy and give consent to processing of the data as part of this job application.</label>
        </div>
