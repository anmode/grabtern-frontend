export default [
  {
    hackathonImage: "/assets/img/hackathons/Solve_for_Tomorrow_346x219_1_346x210_1_346x205_1_346x202_1_346x200.webp",
   ...
   , bookmarked: false  },
  {
    hackathonImage: "/assets/img/hackathons/girls3_384x219.webp",
  ...
  {
    hackathonImage: "/assets/img/hackathons/codecrush.webp",
    hackathonTitle: "Code Crush",
    hackathonDescription:"CodeCrush is an exciting Hackathon that provides a platform for developers, designers, and other tech enthusiasts to showcase their coding skills, work collaboratively, and create innovative solutions to real-world problems. ."
    , bookmarked: false,
    tags: ["upcoming","Programming"] },
  {
  ...
  {
    hackathonImage: "/assets/img/hackathons/gcccode.webp",
    hackathonImageAlt: "GCC CODE Hackathon",
    hackathonLink: "https://codehackathon.github.io/",
    hackathonTitle: "GCC CODE Hackathon",
    hackathonDescription:"In collaboration with the Department of CSE, we organise frequent coding competitions called 'Code Hackathons' on a bi-monthly basis on Saturday afternoons."
    , bookmarked: false ,tags: ["upcoming","Programming"] },
  {
  ...
  {
    hackathonImage: "/assets/img/hackathons/north.webp",
    ...
    tags: ["web","upcoming"]},
    {
      hackathonImage: "/assets/img/hackathons/image.webp",
      hackathonImageAlt: "Chainlink Hackathon",
      hackathonLink: "https://chain.link/hackathon",
      hackathonTitle: "Chainlink Hackathon",
      hackathonDescription:"New tools. Bigger ideas. Limitless opportunities. Web3 builders have more tools than ever before. Now is the time to build the next breakthrough dApp."
      , bookmarked: false ,
      tags: ["Blockchain","upcoming"]},
      {
        ...
        hackathonDescription:"Join us at the kickoff of our summer 2023 hackathon dedicated to building Solana projects and answering related challenges."
        , bookmarked: false ,
        tags: ["Blockchain","upcoming"]},
        {
          ...
          hackathonDescription:"After weeks of hacking, the Internet Computer BUIDL Bitcoin Hackathon Powered by Encode has come to an end. Come and see the best projects from the hackathon pitch for the top prizes during the Finale and Prizegiving event."
          , bookmarked: false ,
          tags: ["Blockchain","upcoming"]}
];
