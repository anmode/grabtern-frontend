        ...
        >
          <div className=" d-flex flex-column justify-content-start tw-border-[2px] tw-rounded-lg tw-border-black tw-py-[50px] tw-px-[70px]">
            ...
            <div className=" tw-flex tw-flex-col  tw-mb-10">
              <label for="name" className="tw-text-3xl tw-text-left tw-font-medium tw-mr-10">Email</label>
              <input
                type="email"
                name="email"
                placeholder="Email"
            ...
            <div className="tw-flex tw-flex-col  tw-mb-10">
              <label for="name" className="tw-text-3xl tw-font-medium ">Password</label>
              <input
                type="password"
                name="password"
