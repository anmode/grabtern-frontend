      ...
      <div class={styles.TNCcontainer}>
        ...
        <div data-custom-class="body">
          ...
          <div align="center" style={{ textAlign: "left" }}>
            ...
            >
              <bdt className="question">
                In our platform, we connect former Mentors to student seeking
                for mentorship and mentor charge for providing mentorship and we
                take 11% of that.
              </bdt>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                <bdt className="question">contact.grabtern@gmail.com</bdt>, as
        ...
        <div className="terms-and-cond" id="2" style={{ marginTop: 45 }}>
          ...
          <div className="terms-and-cond-sub">
            <div className="tnc-sub-head">12. TERM AND TERMINATION</div>
          ...
          <div className="terms-and-cond-sub">
            ...
            laws of India. Grabtern and yourself irrevocably consent that the
          ...
          <div className="terms-and-cond-sub">
            ...
            eleven (11) days before initiating arbitration. Such informal
            ...
            arbitration shall be Aligarh, India. The language of the proceedings
          ...
          <div className="terms-and-cond-sub">
            <div className="tnc-sub-head">23. CONTACT US</div>
